    ...
    MobileCalendar.prototype = {
        ...
        bindEvent: function(type) {
            ...
            function finishMobileDate(e) {
                console.log(_self.gearDate.querySelector(".date_mm").getAttribute("val")+"/"+_self.gearDate.querySelector(".date_dd").getAttribute("val"));
                var passY = _self.maxY - _self.minY + 1;
                var date_yy = parseInt(Math.round(_self.gearDate.querySelector(".date_yy").getAttribute("val")));
                var date_mm = parseInt(Math.round(_self.gearDate.querySelector(".date_mm").getAttribute("val")=='NaN'?new Date().getMonth():_self.gearDate.querySelector(".date_mm").getAttribute("val"))) + 1;
                date_mm = date_mm > 9 ? date_mm : '0' + date_mm;
                var date_dd = parseInt(Math.round(_self.gearDate.querySelector(".date_dd").getAttribute("val")=='NaN'?new Date().getDate()-1:_self.gearDate.querySelector(".date_dd").getAttribute("val")))+1;
