...
function(e) {
    ...
    this.configDatePicker = function(t) {
        angular.extend(e, t)
    }, this.$get = ["$rootScope", "$ionicPopup", "$ionicModal", "IonicDatepickerService",
        function(t, n, o, a) {
            function i(e) {
            ...
            function c(e) {
                e.disabledDates && 0 !== e.disabledDates.length ? angular.forEach(e.disabledDates, function(e, t) {
            ...
            function r(e) {
                ...
                u.monthsList = [], u.monthsList = u.mainObj.monthsList && 12 === u.mainObj.monthsList.length ? u.mainObj.monthsList : a.monthsList, u.yearsList = a.getYearsList(u.mainObj.from, u.mainObj.to), u.dayList = [];
                var o, c;
                ...
                for (var r = t; n >= r; r++) o = new Date(e.getFullYear(), e.getMonth(), r), c = o.getTime() < u.fromDate || o.getTime() > u.toDate || u.mainObj.disableWeekdays.indexOf(o.getDay()) >= 0, u.dayList.push({
                    date: o.getDate(),
                    month: o.getMonth(),
                    year: o.getFullYear(),
                    day: o.getDay(),
                ...
                var d = u.dayList[0].day - u.mainObj.mondayFirst;
                d = 0 > d ? 6 : d;
                for (var p = 0; d > p; p++) u.dayList.unshift({});
                u.rows = [0, 7, 14, 21, 28, 35], u.cols = [0, 1, 2, 3, 4, 5, 6], u.currentMonth = u.mainObj.monthsList[e.getMonth()], u.currentYear = e.getFullYear(), u.currentMonthSelected = angular.copy(u.currentMonth), u.currentYearSelected = angular.copy(u.currentYear), u.numColumns = 7
            }

            function d(e) {
                u.mainObj = angular.copy(e), u.selctedDateEpoch = i(u.mainObj.inputDate).getTime(), u.weeksList = u.mainObj.weeksList && 7 === u.mainObj.weeksList.length ? u.mainObj.weeksList : ["S", "M", "T", "W", "T", "F", "S"], u.mainObj.mondayFirst && u.weeksList.push(u.mainObj.weeksList.shift()), u.disableWeekdays = u.mainObj.disableWeekdays, r(u.mainObj.inputDate), c(u.mainObj)
            }
            ...
            var s = {},
                u = t.$new();
            return u.today = i(new Date).getTime(), u.disabledDates = [], u.prevMonth = function() {
                1 === u.currentDate.getMonth() && u.currentDate.setFullYear(u.currentDate.getFullYear()), u.currentDate.setMonth(u.currentDate.getMonth() - 1), u.currentMonth = u.mainObj.monthsList[u.currentDate.getMonth()], u.currentYear = u.currentDate.getFullYear(), r(u.currentDate)
            }, u.nextMonth = function() {
                11 === u.currentDate.getMonth() && u.currentDate.setFullYear(u.currentDate.getFullYear()), u.currentDate.setDate(1), u.currentDate.setMonth(u.currentDate.getMonth() + 1), u.currentMonth = u.mainObj.monthsList[u.currentDate.getMonth()], u.currentYear = u.currentDate.getFullYear(), r(u.currentDate)
                ...
                var e = new Date;
                r(new Date), u.selctedDateEpoch = i(e).getTime(), u.mainObj.closeOnSelect && (u.mainObj.callback(u.selctedDateEpoch), l())
                ...
                u.currentDate.setMonth(t), r(u.currentDate)
            }, u.yearChanged = function(e) {
                u.currentDate.setFullYear(e), r(u.currentDate)
            }, o.fromTemplateUrl("ionic-datepicker-modal.tpl.html", {
                scope: u,
                ...
                var o = [];
                u.mainObj = angular.extend({}, e, t), u.mainObj.from && (u.fromDate = i(new Date(u.mainObj.from)).getTime()), u.mainObj.to && (u.toDate = i(new Date(u.mainObj.to)).getTime()), t.disableWeekdays && e.disableWeekdays && (u.mainObj.disableWeekdays = t.disableWeekdays.concat(e.disableWeekdays)), d(u.mainObj), u.mainObj.closeOnSelect || (o = [{
                    ...
                    onTap: function(e) {
                        var t = new Date;
                        r(new Date), u.selctedDateEpoch = i(t).getTime(), u.mainObj.closeOnSelect || e.preventDefault()
                    }
                }), o.push({
                    ...
                    templateUrl: "ionic-datepicker-popup.tpl.html",
                    scope: u,
    ...
    this.monthsList = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], this.getYearsList = function(e, t) {
        var n = [],
            o = 1900,
            a = 2100;
        o = e ? new Date(e).getFullYear() : o, a = t ? new Date(t).getFullYear() : a;
        for (var i = o; a >= i; i++) n.push(i);
        return n
    }
});